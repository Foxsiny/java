...
class List {
    constructor(url, container, list = list2) {
        ...
        this.goods = [];
        this.url = url;
        this.allProducts = [];//массив обьектов
        this._init();
    }
    getJson(url) {
...
//Цель конструктора каталога и корзины одна и таже:
//1) Регистрация событий по клику на кнопку купить
//2) заполнить массив товаров из файла JSON
//3) Вывод данных на странице, используя метод handleData, который заполняет
// глобальный массив товаров и выводит их на странице, вызывая render
