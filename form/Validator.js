class Validator {
    ...
    _validateForm() {
        ...
        let formFilds = [...document.getElementById(this.form).getElementsByTagName('input')];
        for (let field of formFilds) {
    ...
    _watchField(field) {
        field.addEventListener('input', () => {
            let error = field.parentNote.querySelector(`.${this.errorClass}`);
            if (this.patterns[field.name].test(field.value)) {
